...
export const FirebaseIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg fill="currentColor" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M93.18,329.89,47.54,363.31,16,325.21l45.45-35.34a23.46,23.46,0,0,1,31.73,2ZM464.46,325.21l-31.54,38.1L247.5,144.38,154.12,382.55,88.4,265.5,217.65,48ZM265.17,464l93.38-179.8-59.53-46.06Z"/>
    </svg>
);
...
export const LogoIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Rocket Body */}
        <path d="M12 2 C10 6, 9.5 10, 9.5 17 H 14.5 C 14.5 10, 14 6, 12 2 Z" fill="currentColor" />
        {/* Window */}
        <circle cx="12" cy="9" r="2.5" fill="#4b5563" stroke="currentColor" strokeWidth="1" />
    </svg>
);
...
export const ArrowPathIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.18-3.185m-3.18-3.182l-3.182 3.182a8.25 8.25 0 01-11.664 0l-3.18-3.185m3.18 3.182V6.108c0-1.104.896-2 2-2h4.992a2 2 0 012 2v4.992m-2-4.992l-3.182 3.182" />
  </svg>
);
...
export const LockClosedIcon: React.FC<{ className?: string; title?: string }> = ({ className, title }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const ClipboardCheckIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9l-3.75 3.75-1.5-1.5M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v0a2.25 2.25 0 01-2.25 2.25h-1.5a2.25 2.25 0 01-2.25-2.25V5.132c0-.212.029-.418.084-.612m7.332 0c.646.049 1.288.11 1.927.184 1.1.128 1.907 1.077 1.907 2.185V19.5a2.25 2.25 0 01-2.25 2.25H6.75A2.25 2.25 0 014.5 19.5V7.22c0-1.108.806-2.057 1.907-2.2185a48.208 48.208 0 011.927-.184" />
  </svg>
);
