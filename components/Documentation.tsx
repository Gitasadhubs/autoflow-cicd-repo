...
const YamlBlock: React.FC<{ children: string }> = ({ children }) => (
    <div className="bg-gray-100 dark:bg-gray-900 rounded-md p-3 my-2 border border-gray-200 dark:border-gray-700">
        <pre><code className="text-sm text-gray-800 dark:text-gray-200 font-mono">{children.trim()}</code></pre>
    </div>
);
    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center p-4 z-50">
      <div className="bg-light-surface dark:bg-brand-surface rounded-xl shadow-2xl w-full max-w-3xl transform transition-all animate-scale-up border border-gray-200 dark:border-gray-700">
        <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">AutoFlow Documentation</h2>
        ...
        <div className="p-6 space-y-6 max-h-[75vh] overflow-y-auto text-gray-700 dark:text-gray-300">
            
            <section>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Welcome to AutoFlow!</h3>
            ...
            <section>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Getting Started</h3>
            ...
            <section>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">How to Configure a Pipeline</h3>
                ...
                <ol className="list-decimal list-inside mt-2 ml-4 space-y-4">
                    <li>
                        <strong className="text-gray-800 dark:text-gray-200">Select Settings:</strong> Choose your project's Tech Stack, your desired Deployment Target, and the Environment (e.g., Production).
                    </li>
                    <li>
                        <strong className="text-gray-800 dark:text-gray-200">Generate Workflow:</strong> Click "Generate Workflow File". AutoFlow sends your settings to an AI that specializes in DevOps to create a custom GitHub Actions YAML file tailored to your needs.
                    </li>
                    <li>
                        <strong className="text-gray-800 dark:text-gray-200">Configure Variables and Secrets:</strong> The generated workflow often requires configuration.
                        <ul className="list-disc list-inside mt-2 ml-4 space-y-2 text-sm">
                            ...
                            <li><strong>Secrets</strong> are for sensitive information like API tokens or passwords. They are stored encrypted by GitHub and are never exposed in logs. <strong className="text-amber-600 dark:text-amber-400">Never commit secrets directly into your code.</strong></li>
                        </ul>
                    </li>
                     <li>
                        <strong className="text-gray-800 dark:text-gray-200">Confirm Setup:</strong> Once you've filled in the required values, click "Confirm Setup". AutoFlow will:
            ...
            <section>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Deployment Target Examples</h3>
...
- name: Deploy to Vercel
  ...
  env:
    ...
    VERCEL_PROJECT_ID: \${{ secrets.VERCEL_PROJECT_ID }}
                ...
                <div className="mt-6">
                    <h4 className="text-lg font-medium text-gray-800 dark:text-gray-200">Example 2: Static HTML/JS to GitHub Pages</h4>
...
- name: Deploy to GitHub Pages
  uses: actions/deploy-pages@v2
                ...
                <div className="mt-6">
                    <h4 className="text-lg font-medium text-gray-800 dark:text-gray-200">Example 3: Node.js to Railway</h4>
                    <p className="text-sm">Railway is a modern deployment platform that simplifies infrastructure. Deploying a Node.js app is straightforward using their CLI.</p>
                    <p className="text-sm mt-2 font-semibold">Typical Secrets:</p>
                    <ul className="list-disc list-inside mt-1 ml-4 text-sm">
                        <li><Code>RAILWAY_TOKEN</Code>: Your Railway account token, found in your account settings on their website. This is required for authentication.</li>
                    </ul>
                    <p className="text-sm mt-2 font-semibold">Example Workflow Snippet:</p>
                    <YamlBlock>{`
- name: Deploy to Railway
  ...
  env:
    RAILWAY_TOKEN: \${{ secrets.RAILWAY_TOKEN }}
             ...
             <section>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Troubleshooting</h3>
                <ul className="list-disc list-inside mt-2 ml-4 space-y-2">
                    <li>
                        <strong className="text-gray-800 dark:text-gray-200">My repositories aren't showing up.</strong>
                     ...
                     <li>
                        <strong className="text-gray-800 dark:text-gray-200">My pipeline failed.</strong>
        ...
        <div className="px-6 py-3 bg-gray-50 dark:bg-gray-900/50 flex justify-end rounded-b-xl border-t border-gray-200 dark:border-gray-700">
