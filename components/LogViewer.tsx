    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center p-4 z-50">
      <div className="bg-light-surface dark:bg-brand-surface rounded-xl shadow-2xl w-full max-w-2xl transform transition-all animate-scale-up border border-gray-200 dark:border-gray-700">
        <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
          <div>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Deployment Details</h2>
        ...
        <div className="p-6 space-y-4">
            <div className="grid grid-cols-3 gap-4 text-sm">
                <span className="font-semibold text-gray-500 dark:text-gray-400">Commit Message:</span>
                <span className="col-span-2 text-gray-800 dark:text-gray-200">{deployment.description || 'N/A'}</span>

                <span className="font-semibold text-gray-500 dark:text-gray-400">Branch/Ref:</span>
                <span className="col-span-2 text-gray-800 dark:text-gray-200 font-mono">{deployment.ref}</span>

                <span className="font-semibold text-gray-500 dark:text-gray-400">Environment:</span>
                <span className="col-span-2 text-gray-800 dark:text-gray-200">{deployment.environment}</span>

                <span className="font-semibold text-gray-500 dark:text-gray-400">Triggered By:</span>
